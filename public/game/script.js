...
class Player {
    ...
    update(){
        ...
        if (gameFrame % 5 == 0){
            ...
            if (this.grame == 3 || this.frame == 7 || this.frame || 11){
                this.frameX = 0;
            } else {
                this.frameX++;
            }
...
// Bubbles
const bubblesArray = []
const bubleImage = new Image();
bubleImage.src = 'bubble_pop_frame_01.png';
...
class Bubble {
    ...
    draw(){
        ...
        ctx.closePath();
        ctx.stroke();*/
        ctx.drawImage(bubleImage, this.x - 65, this.y - 65, this.radius * 2.6, this.radius * 2.6 );
    }
}
...
bubblePop2.src = 'bubbles-single3.wav';
